...
```
应用窗口对应AppWindowToken，
系统窗口对应WindowToken，
子窗口对应父窗口ViewRootImpl的W对象
...
AppWindowToken继承WindowToken，
WindowToken继承WindowContainer，
WindowState也是继承WindowContainer，
WindowList是WindowContainer的成员变量，是一个ArrayList
```
