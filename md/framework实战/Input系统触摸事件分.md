...
发布时间：2023-03-02 14:25:49 来源：亿速云 阅读：426 作者：iii 栏目：[开发技术](https://www.yisu.com/jc/kf/)
...
+   返回 ACTION\_PASS\_TO\_USER ，表示不截断触摸事件，也就是把触摸事件分发给用户/窗口。
...
+   策略标志位包含 FLAG\_WAKE ，它会导致屏幕被唤醒，因此需要截断触摸事件。FLAG\_WAKE 一般来自于输入设备的配置文件。
    
+   没有锁屏，没有梦境，也没有 FLAG\_WAKE，默认就会截断。
