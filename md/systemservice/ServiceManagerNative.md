...
{  
    /**  
     * Cast a Binder object into a service manager interface, generating     * a proxy if needed.     */    @UnsupportedAppUsage  
    ...
    public String[] listServices(int dumpPriority) throws RemoteException {  
        ...
        while (true) {  
            ...
            try {  
                ...
                // cause the call to throw an exception back instead of                // returning a nice result...  so eat it here and go on.                break;  
            }  
