...
**看Application启动图**：  
![Activity启动流程1.png](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/2da4a5efc8904eb68e6d8ca6b0f066c4.png?x-oss-process=image/resize,w_1400/format,webp "Activity启动流程1.png")
...
![Activity启动流程.png](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/526aacc4f56f4e47bf924fe9a9eddb04.png?x-oss-process=image/resize,w_1400/format,webp "Activity启动流程.png")
...
总结下我们应用可优化路径。  
![启动优化全路径.awebp](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/ada14491a00f4970a7461e4c42d262e5.webp?x-oss-process=image/resize,w_1400/format,webp "启动优化全路径.awebp")  
...
![启动耗时分析.awebp](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/35d6c48a5e1d4a4cac5a8b259b6552b1.webp?x-oss-process=image/resize,w_1400/format,webp "启动耗时分析.awebp")  
**UI构建阶段**：
...
![systrace截图.png](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/ecf3f6db1a0341e297bd6b88ccd3f2eb.png?x-oss-process=image/resize,w_1400/format,webp "systrace截图.png")
...
![androidprofile.png](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/d856c5627f5e492aba71e4ee4ed238f3.png?x-oss-process=image/resize,w_1400/format,webp "androidprofile.png")

### Rhea

字节自研的新一代全能型性能分析工具，功能强大，且性能损耗低。缺点就是还不支持windows获取html文件。  
地址：[https://juejin.cn/post/7052625610295738382](https://juejin.cn/post/7052625610295738382)

![打点工具对比.png](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/3875f173af3040e296b2b046846065f3.png?x-oss-process=image/resize,w_1400/format,webp "打点工具对比.png")
...
![FileProvider耗时分析.awebp](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/a56b4b5627e44516bb8a5cef79a2d6c5.webp?x-oss-process=image/resize,w_1400/format,webp "FileProvider耗时分析.awebp")  
...
![启动器.awebp](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/ab4cba06a8364f01aa4d760d17200307.webp?x-oss-process=image/resize,w_1400/format,webp "启动器.awebp")  
`启动器流程`：  
...
![两个Activity合并图.awebp](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/24127940914b452081df2651a0e74f32.webp?x-oss-process=image/resize,w_1400/format,webp "两个Activity合并图.awebp")  
合并后收益：
...
![Activityalia.awebp](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/747c488f7d7d4175afec56db1c52db6d.webp?x-oss-process=image/resize,w_1400/format,webp "Activityalia.awebp")  
接下来我们来看一下第二个问题。
...
![合并方法.awebp](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/3c7be2642f6941d592f1e6514bf5a996.webp?x-oss-process=image/resize,w_1400/format,webp "合并方法.awebp")  
**多实例问题**：
...
![合并后.awebp](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/4b11aac93aa14d3a890a6ee30579bc62.webp?x-oss-process=image/resize,w_1400/format,webp "合并后.awebp")  
...
![合并外部调用.awebp](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/28a6da0e51134e49a435886043a3fae0.webp?x-oss-process=image/resize,w_1400/format,webp "合并外部调用.awebp")  
具体来说我们的优化方案如下：
...
![x2c.awebp](https://ucc.alicdn.com/q6pomtsnhxs7g/developer-article1161022/20241026/dfde1dfa7e724b978bc8a8755a03579f.webp?x-oss-process=image/resize,w_1400/format,webp "x2c.awebp")  
**传统优化方式**：
